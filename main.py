...
feels_like_celsius, feels_like_fehrenheit = kelvin_to_celsius_fahrenheit(feels_like_kelvin)
...
print(f"Temperature in {CITY} feel like: {feels_like_celsius:.2f}℃ or {feels_like_fehrenheit:.2f}℉")
